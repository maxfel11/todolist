...
const NavBar = () => {
  ...
  return (
    <div className="fixed w-full top-0 z-30 m-0 md:pr-72 shadow bg-white ">
      <div className="w-full flex items-center relative bg-white dark:bg-neutral-800 z-30 shadow text-neutral-700 dark:text-neutral-300  relative px-3 md:px-4 lg:px-6 ">
